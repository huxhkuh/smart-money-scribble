...
CREATE POLICY "public_read_comments" ON public.comments AS PERMISSIVE FOR SELECT USING (true);
CREATE POLICY "public_insert_comments" ON public.comments AS PERMISSIVE FOR INSERT WITH CHECK (true);
...
CREATE POLICY "public_read_post_tags" ON public.post_tags AS PERMISSIVE FOR SELECT USING (true);
...
CREATE POLICY "public_read_tags" ON public.tags AS PERMISSIVE FOR SELECT USING (true);
